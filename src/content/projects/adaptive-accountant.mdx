...
### Adaptive Accountant Studio

Adaptive Accountant Studio is a new implementation currently in development from the ground up.
It includes a formal JSON specification for version 2 of the profile format, a ton of new features, quality-of-life improvements and a modern React-based UI.
The goal is to make a publicly available version available soon.
