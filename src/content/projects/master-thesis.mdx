...
image:
  src: '/src/assets/projects/msc-thesis/workflow_large.png'
  alt: 'Workflow Engine'
---
...
## TL;DR
In my Master's thesis called _Data Pipelines in a PolyDBMS_ I created a novel data pipelining tool that is built on top of [Polypheny](https://polypheny.com/).
...
<Aside variant="info">
    Polypheny is what we call a PolyDBMS.
    It unifies access and management of heterogeneous data in different underlying storage engines (PostgreSQL, MongoDB, Neo4j...).
    Any of its supported query languages (SQL, MongoQL, Cypher...) can be used to query the data.
</Aside>
...
<video width="1920" height="1080" controls controlsList="nodownload" oncontextmenu="return false;">
    <source src="/projects/msc-thesis/demo.mp4#t=2.5" type="video/mp4"> </source>
