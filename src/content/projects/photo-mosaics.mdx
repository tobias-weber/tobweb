...
tools: ["Python", "Angular", "ASP.NET Core"]
---
...
For me, the goal of this project is not only to make these mosaics more accessible, but also to become more familiar with the .NET environment and Docker Compose.
